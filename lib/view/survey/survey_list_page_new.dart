...
class _SurveyListPageState extends State<SurveyListPage> {
  ...
  void initState() {
    super.initState();
    print('SurveyListPage initialized with surveyorId: ${widget.surveyorId}');
        ...
        child: Obx(() {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              print('Building survey card for ${survey.id}');
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(survey.attachmentUrls[index]),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
