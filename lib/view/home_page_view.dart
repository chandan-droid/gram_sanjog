                ...
                children: [
                  if(authController.isLoggedIn)
                    UserAccountsDrawerHeader(
                      ...
                      accountName: Text(
                        authController.firebaseUser.value?.name ?? "John Doe",
                        style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18),
                      ),
                      accountEmail: Text(authController.firebaseUser.value?.email as String),
                  ...
                  ListTile(
                    ...
                    title: const Text('Saved Contents',style: TextStyle(color: Colors.white60),),
                    onTap: () {
                  ...
                  if(authController.isLoggedIn)
                    ListTile(
                      ...
                      title: const Text('Log Out',style: TextStyle(color: Colors.white60),),
                      onTap: () {
                  ...
                  if(!authController.isLoggedIn)
                    ListTile(
                      leading:const Icon(Icons.login_rounded,color: Colors.white60),
                      title: const Text('Log In',style: TextStyle(color: Colors.white60),),
                      onTap: () {
